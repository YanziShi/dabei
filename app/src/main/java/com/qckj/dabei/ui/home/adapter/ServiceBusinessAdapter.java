 ...
 */
public class ServiceBusinessAdapter extends SimpleBaseAdapter<ServiceInfo, ServiceBusinessAdapter.ViewHolder> {
    ...
    @Override
    protected void bindView(ServiceBusinessAdapter.ViewHolder viewHolder, ServiceInfo hotMerchantInfo, int position) {
    ...
    @NonNull
    @Override
    protected ServiceBusinessAdapter.ViewHolder onNewViewHolder() {
        return new ServiceBusinessAdapter.ViewHolder();
    }
